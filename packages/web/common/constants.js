...
const finishCategoriesArr = [
  ...
  { name: "xExposed Concrete",
    tag: "xC",
    attr: ["Manufacturer","Product Number","Color","Style","Dimensions","Details","Images","Document",], 
  },
  { name: "xFiber Cement (Lap)",
    tag: "xFL",
    attr: ["Manufacturer","Product Number","Color","Style","Dimensions","Details","Images","Document",], 
  },
  { name: "xFiber Cement (Panel)",
    tag: "xFP",
    attr: ["Manufacturer","Product Number","Color","Style","Dimensions","Details","Images","Document",], 
  },
  { name: "xFiber Cement (Special)",
    tag: "xFS",
    attr: ["Manufacturer","Product Number","Color","Style","Dimensions","Details","Images","Document",], 
  },
  { name: "xFiber Cement (Trim)",
    tag: "xFT",
    attr: ["Manufacturer","Product Number","Color","Style","Dimensions","Details","Images","Document",], 
  },
  { name: "xMetal Siding",
  ...
  { name: "xExposed Structural Steel",
    tag: "xSS",
    attr: ["Manufacturer","Product Number","Color","Style","Dimensions","Details","Images","Document",], 
  },
  { name: "xExhaust Vents",
  ...
  { name: "xBuilding Mounted Lighting",
    tag: "xL",
    attr: ["Manufacturer","Product Number","Color","Style","Dimensions","Details","Images","Document",], 
  }
];
